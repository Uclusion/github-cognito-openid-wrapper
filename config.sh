...
export COGNITO_REDIRECT_URI=https://$env_name.auth.uclusion.com/oauth2/idpresponse
...
export BUCKET_NAME=congito-github-wrapper-bucket-$env_name # An S3 bucket name to use as the deployment pipeline
